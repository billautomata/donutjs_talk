...
},{"../src/lib/particle/main.js":7}],3:[function(require,module,exports){
...
module.exports = function emitter(_svg) {
  ...
  return {
    tick: tick,
    set_color: set_color,
    get_particles: function get_particles() {
      return particles;
    },
    ...
    add_force: function add_force(f) {
      force_fns.push(f);
    },
...
},{"./particle.js":8}],5:[function(require,module,exports){
'use strict';

var vector = require('../vector.js'); // static methods will be used with calculating forces
module.exports = function gravity_maker(_mag, _clamp, _direction, min_distance) {
...
},{"../vector.js":9}],6:[function(require,module,exports){
'use strict';
...
module.exports = function () {
  ...
  function p5noise(options) {
    ...
    return function _p5nose(particle, host) {
      ...
      var v = particle.get_velocity();
      v.val.x += options.amount * (noisex(p.val.x * options.sample_multiplier, p.val.y * options.sample_multiplier, t) - 0.46);
      v.val.y += options.amount * (noisey(p.val.x * options.sample_multiplier, p.val.y * options.sample_multiplier, t) - 0.46);
    };
  }
...
},{"../../../js/perlin_noise.js":1,"./forces/gravity.js":5,"./forces/linear_gravity.js":6,"./vector.js":9,"./world.js":10}],8:[function(require,module,exports){
'use strict';
...
module.exports = function particle(_svg) {
  ...
  return {
    ...
    get_velocity: function get_velocity() {
      return vel;
    },
    get_circle: function get_circle() {
      return circle;
    }
  };
};
...
module.exports = function vector(ox, oy) {
  ...
  function add(ox, oy) {
    if ((typeof ox === 'undefined' ? 'undefined' : _typeof(ox)) === 'object') {
      return addv(ox);
    }
    val.x += ox;
    val.y += oy;
...
module.exports = function world() {
  ...
  function init(worldname) {
    ...
    svg.style('background-color', 'rgba(0,0,0,1)').style('width', '100%');
  ...
  return {
    ...
    get_svg: function get_svg() {
      return svg;
    },
    get_emitters: function get_emitters() {
      return emitters;
    },
    init: init,
    tick: tick
